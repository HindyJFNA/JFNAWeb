        ...
        displayResults.forEach(function (org) {
            ...
            <li class="result" data-federation-name="${org.n || ''}" data-organization-id="${org.id || ''}">
                ...
                <div class="fed-card">
                    ...
                    ${org.w ? `<ul><li><p>Website:</p></li><li><a class="button blue" href="${org.w}" target="_blank">Learn More <img src="https://cdn.fedweb.org/fed-42/2/icon.svg"></a></li></ul>` : ''}
                    ${org.d ? `<ul><li><p>Donate:</p></li><li><a class="button blue" href="${org.d}" target="_blank">Donate Now <img src="https://cdn.fedweb.org/fed-42/2/icon.svg"></a></li></ul>` : ''}
                </div>
            </li>
        `;
    ...
    am5.ready(function () {
        ...
        function fetchMapData() {
            ...
            if (hasValidMapCache() && loadMapDataFromCache()) {
                ...
                setTimeout(function () {
                    ...
                    fetch('https://cdn.jsdelivr.net/gh/tobiattada/jfna@00ea358d98301358f837c0cd8ac7d5825c3ab45d/map-data')
                        .then(response => {
                            if (!response.ok) {
        ...
        if (hasValidCache() && loadFromCache()) {
            ...
            setTimeout(function () {
                ...
                fetch('https://cdn.jsdelivr.net/gh/tobiattada/jfna@ba3b0a4e08d2804872068a1c941f129b96dd9c77/all-data')
                    .then(response => {
                        if (!response.ok) {
                            throw new Error('Network response was not ok');
                        }
